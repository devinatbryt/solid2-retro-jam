> **Vendored from `node_modules/solid-js/CHEATSHEET.md` (solid-js 2.0.0-rc.6).**
> It ships inside the package. Copied here so it is one click away during the
> jam. If it ever disagrees with the installed version, the installed one wins.
